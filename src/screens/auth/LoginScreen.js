    ...
    >
      ...
      >
        ...
        <View style={theme.formContainer}>
          ...
          {/* Error Box - shown after failed login */}
          {loginError && (
            <View style={loginStyles.errorBox}>
              <Text style={loginStyles.errorText}>{loginError}</Text>
              <Text style={loginStyles.errorHelpText}>Usikker på hvad der er forkert?</Text>
              <TouchableOpacity onPress={() => navigation.navigate('ForgotPassword')}>
                <Text style={loginStyles.errorResetLink}>Nulstil din adgangskode</Text>
              </TouchableOpacity>
            </View>
          )}
